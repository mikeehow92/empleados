 ...
 */const Lv=function(t){const e=[];let n=0;for(let r=0;r<t.length;r++){let i=t.charCodeAt(r);i<128?e[n++]=i:i<2048?(e[n++]=i>>6|192,e[n++]=i&63|128):(i&64512)===55296&&r+1<t.length&&(t.charCodeAt(r+1)&64512)===56320?(i=65536+((i&1023)<<10)+(t.charCodeAt(++r)&1023),e[n++]=i>>18|240,e[n++]=i>>12&63|128,e[n++]=i>>6&63|128,e[n++]=i&63|128):(e[n++]=i>>12|224,e[n++]=i>>6&63|128,e[n++]=i&63|128)}return e},IA=function(t){const e=[];let n=0,r=0;for(;n<t.length;){const i=t[n++];if(i<128)e[r++]=String.fromCharCode(i);else if(i>191&&i<224){const s=t[n++];e[r++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=t[n++],o=t[n++],l=t[n++],u=((i&7)<<18|(s&63)<<12|(o&63)<<6|l&63)-65536;e[r++]=String.fromCharCode(55296+(u>>10)),e[r++]=String.fromCharCode(56320+(u&1023))}else{const s=t[n++],o=t[n++];e[r++]=String.fromCharCode((i&15)<<12|(s&63)<<6|o&63)}}return e.join("")},Mv={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let i=0;i<t.length;i+=3){const s=t[i],o=i+1<t.length,l=o?t[i+1]:0,u=i+2<t.length,h=u?t[i+2]:0,f=s>>2,p=(s&3)<<4|l>>4;let g=(l&15)<<2|h>>6,S=h&63;u||(S=64,o||(g=64)),r.push(n[f],n[p],n[g],n[S])}return r.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(Lv(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):IA(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let i=0;i<t.length;){const s=n[t.charAt(i++)],l=i<t.length?n[t.charAt(i)]:0;++i;const h=i<t.length?n[t.charAt(i)]:64;++i;const p=i<t.length?n[t.charAt(i)]:64;if(++i,s==null||l==null||h==null||p==null)throw new AA;const g=s<<2|l>>4;if(r.push(g),h!==64){const S=l<<4&240|h>>2;if(r.push(S),p!==64){const P=h<<6&192|p;r.push(P)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class AA extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const SA=function(t){const e=Lv(t);return Mv.encodeByteArray(e,!0)},Sl=function(t){return SA(t).replace(/\./g,"")},Uv=function(t){try{return Mv.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jA="FirebaseError";class sn extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=jA,Object.setPrototypeOf(this,sn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Do.prototype.create)}}class Do{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,s=this.errors[e],o=s?BA(s,r):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new sn(i,l,r)}}function BA(t,e){return t.replace(zA,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const zA=/\{\$([^}]+)}/g;function $A(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Rl(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const i of n){if(!r.includes(i))return!1;const s=t[i],o=e[i];if(ng(s)&&ng(o)){if(!Rl(s,o))return!1}else if(s!==o)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function ng(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KA{constructor(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){const r=new xA;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:n});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(e){var n;const r=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),i=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(s){if(i)return null;throw s}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(QA(e))try{this.getOrInitializeService({instanceIdentifier:Rr})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(n);try{const s=this.getOrInitializeService({instanceIdentifier:i});r.resolve(s)}catch{}}}}clearInstance(e=Rr){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...e.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Rr){return this.instances.has(e)}getOptions(e=Rr){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:n={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[s,o]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);r===l&&o.resolve(i)}return i}onInit(e,n){var r;const i=this.normalizeInstanceIdentifier(n),s=(r=this.onInitCallbacks.get(i))!==null&&r!==void 0?r:new Set;s.add(e),this.onInitCallbacks.set(i,s);const o=this.instances.get(i);return o&&e(o,i),()=>{s.delete(e)}}invokeOnInitCallbacks(e,n){const r=this.onInitCallbacks.get(n);if(r)for(const i of r)try{i(e,n)}catch{}}getOrInitializeService({instanceIdentifier:e,options:n={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:GA(e),options:n}),this.instances.set(e,r),this.instancesOptions.set(e,n),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Rr){return this.component?this.component.multipleInstances?e:Rr:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function GA(t){return t===Rr?void 0:t}function QA(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ee;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ee||(ee={}));const XA={debug:ee.DEBUG,verbose:ee.VERBOSE,info:ee.INFO,warn:ee.WARN,error:ee.ERROR,silent:ee.SILENT},JA=ee.INFO,ZA={[ee.DEBUG]:"log",[ee.VERBOSE]:"log",[ee.INFO]:"info",[ee.WARN]:"warn",[ee.ERROR]:"error"},eS=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),i=ZA[e];if(i)console[i](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Wd{constructor(e){this.name=e,this._logLevel=JA,this._logHandler=eS,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ee))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?XA[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ee.DEBUG,...e),this._logHandler(this,ee.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ee.VERBOSE,...e),this._logHandler(this,ee.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ee.INFO,...e),this._logHandler(this,ee.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ee.WARN,...e),this._logHandler(this,ee.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ee.ERROR,...e),this._logHandler(this,ee.ERROR,...e)}}const tS=(t,e)=>e.some(n=>t instanceof n);let rg,ig;function nS(){return rg||(rg=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function rS(){return ig||(ig=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Wv=new WeakMap,Ah=new WeakMap,qv=new WeakMap,vc=new WeakMap,qd=new WeakMap;function iS(t){const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("success",s),t.removeEventListener("error",o)},s=()=>{n(ir(t.result)),i()},o=()=>{r(t.error),i()};t.addEventListener("success",s),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&Wv.set(n,t)}).catch(()=>{}),qd.set(e,t),e}function sS(t){if(Ah.has(t))return;const e=new Promise((n,r)=>{const i=()=>{t.removeEventListener("complete",s),t.removeEventListener("error",o),t.removeEventListener("abort",o)},s=()=>{n(),i()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",s),t.addEventListener("error",o),t.addEventListener("abort",o)});Ah.set(t,e)}let Sh={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Ah.get(t);if(e==="objectStoreNames")return t.objectStoreNames||qv.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return ir(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function oS(t){Sh=t(Sh)}function aS(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(wc(this),e,...n);return qv.set(r,e.sort?e.sort():[e]),ir(r)}:rS().includes(t)?function(...e){return t.apply(wc(this),e),ir(Wv.get(this))}:function(...e){return ir(t.apply(wc(this),e))}}function lS(t){return typeof t=="function"?aS(t):(t instanceof IDBTransaction&&sS(t),tS(t,nS())?new Proxy(t,Sh):t)}function ir(t){if(t instanceof IDBRequest)return iS(t);if(vc.has(t))return vc.get(t);const e=lS(t);return e!==t&&(vc.set(t,e),qd.set(e,t)),e}const wc=t=>qd.get(t);function uS(t,e,{blocked:n,upgrade:r,blocking:i,terminated:s}={}){const o=indexedDB.open(t,e),l=ir(o);return r&&o.addEventListener("upgradeneeded",u=>{r(ir(o.result),u.oldVersion,u.newVersion,ir(o.transaction),u)}),n&&o.addEventListener("blocked",u=>n(u.oldVersion,u.newVersion,u)),l.then(u=>{s&&u.addEventListener("close",()=>s()),i&&u.addEventListener("versionchange",h=>i(h.oldVersion,h.newVersion,h))}).catch(()=>{}),l}const cS=["get","getKey","getAll","getAllKeys","count"],hS=["put","add","delete","clear"],Ec=new Map;function sg(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Ec.get(e))return Ec.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,i=hS.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||cS.includes(n)))return;const s=async function(o,...l){const u=this.transaction(o,i?"readwrite":"readonly");let h=u.store;return r&&(h=h.index(l.shift())),(await Promise.all([h[n](...l),i&&u.done]))[0]};return Ec.set(e,s),s}oS(t=>({...t,get:(e,n,r)=>sg(e,n)||t.get(e,n,r),has:(e,n)=>!!sg(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dS{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(fS(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function fS(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Rh="@firebase/app",og="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=new Wd("@firebase/app"),pS="@firebase/app-compat",mS="@firebase/analytics-compat",gS="@firebase/analytics",yS="@firebase/app-check-compat",_S="@firebase/app-check",vS="@firebase/auth",wS="@firebase/auth-compat",ES="@firebase/database",TS="@firebase/data-connect",IS="@firebase/database-compat",AS="@firebase/functions",SS="@firebase/functions-compat",RS="@firebase/installations",PS="@firebase/installations-compat",kS="@firebase/messaging",CS="@firebase/messaging-compat",xS="@firebase/performance",NS="@firebase/performance-compat",DS="@firebase/remote-config",OS="@firebase/remote-config-compat",bS="@firebase/storage",VS="@firebase/storage-compat",LS="@firebase/firestore",MS="@firebase/vertexai-preview",US="@firebase/firestore-compat",FS="firebase",jS="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ph="[DEFAULT]",BS={[Rh]:"fire-core",[pS]:"fire-core-compat",[gS]:"fire-analytics",[mS]:"fire-analytics-compat",[_S]:"fire-app-check",[yS]:"fire-app-check-compat",[vS]:"fire-auth",[wS]:"fire-auth-compat",[ES]:"fire-rtdb",[TS]:"fire-data-connect",[IS]:"fire-rtdb-compat",[AS]:"fire-fn",[SS]:"fire-fn-compat",[RS]:"fire-iid",[PS]:"fire-iid-compat",[kS]:"fire-fcm",[CS]:"fire-fcm-compat",[xS]:"fire-perf",[NS]:"fire-perf-compat",[DS]:"fire-rc",[OS]:"fire-rc-compat",[bS]:"fire-gcs",[VS]:"fire-gcs-compat",[LS]:"fire-fst",[US]:"fire-fst-compat",[MS]:"fire-vertex","fire-js":"fire-js",[FS]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr=jS;function Hd(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Ph,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw sr.create("bad-app-name",{appName:String(i)});if(n||(n=Bv()),!n)throw sr.create("no-options");const s=po.get(i);if(s){if(Rl(n,s.options)&&Rl(r,s.config))return s;throw sr.create("duplicate-app",{appName:i})}const o=new YA(i);for(const u of kh.values())o.addComponent(u);const l=new WS(n,r,o);return po.set(i,l),l}function su(t=Ph){const e=po.get(t);if(!e&&t===Ph&&Bv())return Hd();if(!e)throw sr.create("no-app",{appName:t});return e}function qS(){return Array.from(po.values())}function Xt(t,e,n){var r;let i=(r=BS[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Pn.warn(l.join(" "));return}jr(new cr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HS="firebase-heartbeat-database",KS=1,mo="firebase-heartbeat-store";let Tc=null;function Hv(){return Tc||(Tc=uS(HS,KS,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(mo)}catch(n){console.warn(n)}}}}).catch(t=>{throw sr.create("idb-open",{originalErrorMessage:t.message})})),Tc}async function GS(t){try{const n=(await Hv()).transaction(mo),r=await n.objectStore(mo).get(Kv(t));return await n.done,r}catch(e){if(e instanceof sn)Pn.warn(e.message);else{const n=sr.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Pn.warn(n.message)}}}async function lg(t,e){try{const r=(await Hv()).transaction(mo,"readwrite");await r.objectStore(mo).put(e,Kv(t)),await r.done}catch(n){if(n instanceof sn)Pn.warn(n.message);else{const r=sr.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Pn.warn(r.message)}}}function Kv(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QS=1024,YS=30*24*60*60*1e3;class XS{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new ZS(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=ug();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const l=new Date(o.date).valueOf();return Date.now()-l<=YS}),this._storage.overwrite(this._heartbeatsCache))}catch(r){Pn.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=ug(),{heartbeatsToSend:r,unsentEntries:i}=JS(this._heartbeatsCache.heartbeats),s=Sl(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(n){return Pn.warn(n),""}}}function ug(){return new Date().toISOString().substring(0,10)}function JS(t,e=QS){const n=[];let r=t.slice();for(const i of t){const s=n.find(o=>o.agent===i.agent);if(s){if(s.dates.push(i.date),cg(n)>e){s.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),cg(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class ZS{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return UA()?FA().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await GS(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return lg(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return lg(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function cg(t){return Sl(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eR(t){jr(new cr("platform-logger",e=>new dS(e),"PRIVATE")),jr(new cr("heartbeat",e=>new XS(e),"PRIVATE")),Xt(Rh,og,t),Xt(Rh,og,"esm2017"),Xt("fire-js","")}eR("");var tR="firebase",nR="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl=new Wd("@firebase/auth");function iR(t,...e){Pl.logLevel<=ee.WARN&&Pl.warn(`Auth (${Yr}): ${t}`,...e)}function qa(t,...e){Pl.logLevel<=ee.ERROR&&Pl.error(`Auth (${Yr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oR(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(sR()||bA()||"connection"in navigator)?navigator.onLine:!0}function aR(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo{constructor(e,n){this.shortDelay=e,this.longDelay=n,kn(n>e,"Short delay should be less than long delay!"),this.isMobile=NA()||VA()}get(){return oR()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function mR(t,e=!1){const n=we(t),r=await n.getIdToken(e),i=Yd(r);H(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:Ws(Ic(i.auth_time)),issuedAtTime:Ws(Ic(i.iat)),expirationTime:Ws(Ic(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Ic(t){return Number(t)*1e3}function Yd(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return qa("JWT malformed, contained fewer than 3 sections"),null;try{const i=Uv(n);return i?JSON.parse(i):(qa("Failed to decode base64 JWT payload"),null)}catch(i){return qa("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function fg(t){const e=Yd(t);return H(e,"internal-error"),H(typeof e.exp<"u","internal-error"),H(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){H(e.idToken,"internal-error"),H(typeof e.idToken<"u","internal-error"),H(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):fg(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){H(e.length!==0,"internal-error");const n=fg(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(H(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await wR(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new Ci;return r&&(H(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(H(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(H(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Ci,this.toJSON())}_performRefresh(){return _n("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mn(t,e){H(typeof t=="string"||typeof t>"u","internal-error",{appName:e})}class vn{constructor(e){var{uid:n,auth:r,stsTokenManager:i}=e,s=Kd(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new yR(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=n,this.auth=r,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=s.displayName||null,this.email=s.email||null,this.emailVerified=s.emailVerified||!1,this.phoneNumber=s.phoneNumber||null,this.photoURL=s.photoURL||null,this.isAnonymous=s.isAnonymous||!1,this.tenantId=s.tenantId||null,this.providerData=s.providerData?[...s.providerData]:[],this.metadata=new xh(s.createdAt||void 0,s.lastLoginAt||void 0)}async getIdToken(e){const n=await go(this,this.stsTokenManager.getToken(this.auth,e));return H(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return mR(this,e)}reload(){return _R(this)}_assign(e){this!==e&&(H(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>Object.assign({},n)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new vn(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return n.metadata._copy(this.metadata),n}_onReload(e){H(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),n&&await kl(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Kt(this.auth.app))return Promise.reject(Tn(this.auth));const e=await this.getIdToken();return await go(this,pR(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){var r,i,s,o,l,u,h,f;const p=(r=n.displayName)!==null&&r!==void 0?r:void 0,g=(i=n.email)!==null&&i!==void 0?i:void 0,S=(s=n.phoneNumber)!==null&&s!==void 0?s:void 0,P=(o=n.photoURL)!==null&&o!==void 0?o:void 0,C=(l=n.tenantId)!==null&&l!==void 0?l:void 0,b=(u=n._redirectEventId)!==null&&u!==void 0?u:void 0,T=(h=n.createdAt)!==null&&h!==void 0?h:void 0,_=(f=n.lastLoginAt)!==null&&f!==void 0?f:void 0,{uid:I,emailVerified:D,isAnonymous:M,providerData:F,stsTokenManager:v}=n;H(I&&v,e,"internal-error");const y=Ci.fromJSON(this.name,v);H(typeof I=="string",e,"internal-error"),Mn(p,e.name),Mn(g,e.name),H(typeof D=="boolean",e,"internal-error"),H(typeof M=="boolean",e,"internal-error"),Mn(S,e.name),Mn(P,e.name),Mn(C,e.name),Mn(b,e.name),Mn(T,e.name),Mn(_,e.name);const E=new vn({uid:I,auth:e,email:g,emailVerified:D,displayName:p,isAnonymous:M,photoURL:P,phoneNumber:S,tenantId:C,stsTokenManager:y,createdAt:T,lastLoginAt:_});return F&&Array.isArray(F)&&(E.providerData=F.map(A=>Object.assign({},A))),b&&(E._redirectEventId=b),E}static async _fromIdTokenResponse(e,n,r=!1){const i=new Ci;i.updateFromServerResponse(n);const s=new vn({uid:n.localId,auth:e,stsTokenManager:i,isAnonymous:r});return await kl(s),s}static async _fromGetAccountInfoResponse(e,n,r){const i=n.users[0];H(i.localId!==void 0,"internal-error");const s=i.providerUserInfo!==void 0?tw(i.providerUserInfo):[],o=!(i.email&&i.passwordHash)&&!(s!=null&&s.length),l=new Ci;l.updateFromIdToken(r);const u=new vn({uid:i.localId,auth:e,stsTokenManager:l,isAnonymous:o}),h={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:s,metadata:new xh(i.createdAt,i.lastLoginAt),isAnonymous:!(i.email&&i.passwordHash)&&!(s!=null&&s.length)};return Object.assign(u,h),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ha(t,e,n){return`firebase:${t}:${e}:${n}`}class xi{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Ha(this.userKey,i.apiKey,s),this.fullPersistenceKey=Ha("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?vn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new xi(wn(mg),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||wn(mg);const o=Ha(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const p=vn._fromJSON(e,f);h!==s&&(l=p),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new xi(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new xi(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SR(t,e={}){return _r(t,"GET","/v2/passwordPolicy",yr(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LR(t,e){const n=iu(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(Rl(s,e??{}))return i;zt(i,"already-initialized")}return n.initialize({options:e})}function MR(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(wn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function UR(t,e,n){const r=Xr(t);H(r._canInitEmulator,r,"emulator-config-failed"),H(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=fw(e),{host:o,port:l}=FR(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${s}//${o}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),jR()}function fw(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function FR(t){const e=fw(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:wg(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:wg(o)}}}function wg(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function jR(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HR(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function KR(t){const e=Cs(xs(t)).link,n=e?Cs(xs(e)).deep_link_id:null,r=Cs(xs(t)).deep_link_id;return(r?Cs(xs(r)).link:null)||r||n||e||t}class Zd{constructor(e){var n,r,i,s,o,l;const u=Cs(xs(e)),h=(n=u.apiKey)!==null&&n!==void 0?n:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,p=HR((i=u.mode)!==null&&i!==void 0?i:null);H(h&&f&&p,"argument-error"),this.apiKey=h,this.operation=p,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=KR(e);try{return new Zd(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xi{constructor(){this.providerId=Xi.PROVIDER_ID}static credential(e,n){return yo._fromEmailAndPassword(e,n)}static credentialWithLink(e,n){const r=Zd.parseLink(n);return H(r,"argument-error"),yo._fromEmailAndCode(e,r.code,r.tenantId)}}Xi.PROVIDER_ID="password";Xi.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Xi.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QR(t,e,n=!1){const{auth:r}=t;if(Kt(r.app))return Promise.reject(Tn(r));const i="reauthenticate";try{const s=await go(t,mw(r,i,e,t),n);H(s.idToken,r,"internal-error");const o=Yd(s.idToken);H(o,r,"internal-error");const{sub:l}=o;return H(t.uid===l,r,"user-mismatch"),zr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&zt(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vP(t,e){return e?wn(e):(H(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sw{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:l}=e;if(o){this.reject(o);return}const u={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return wP;case"linkViaPopup":case"linkViaRedirect":return TP;case"reauthViaPopup":case"reauthViaRedirect":return EP;default:zt(this.auth,"internal-error")}}resolve(e){kn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){kn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AP="pendingRedirect",Ka=new Map;class SP extends Sw{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Ka.get(this.auth._key());if(!e){try{const r=await RP(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Ka.set(this.auth._key(),e)}return this.bypassAuthState||Ka.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function RP(t,e){const n=CP(e),r=kP(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function PP(t,e){Ka.set(t._key(),e)}function kP(t){return wn(t._redirectPersistence)}function CP(t){return Ha(AP,t.config.apiKey,t.name)}async function xP(t,e,n=!1){if(Kt(t.app))return Promise.reject(Tn(t));const r=Xr(t),i=vP(r,e),o=await new SP(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FP=new bo(3e4,6e4);function Sg(){const t=Zt().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function jP(t){return new Promise((e,n)=>{var r,i,s;function o(){Sg(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Sg(),n(Jt(t,"network-request-failed"))},timeout:FP.get()})}if(!((i=(r=Zt().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=Zt().gapi)===null||s===void 0)&&s.load)o();else{const l=DR("iframefcb");return Zt()[l]=()=>{gapi.load?o():n(Jt(t,"network-request-failed"))},dw(`${NR()}?onload=${l}`).catch(u=>n(u))}}).catch(e=>{throw Ga=null,e})}let Ga=null;function BP(t){return Ga=Ga||jP(t),Ga}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zP=new bo(5e3,15e3),$P="__/auth/iframe",WP="emulator/auth/iframe",qP={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},HP=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function KP(t){const e=t.config;H(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Qd(e,WP):`https://${t.config.authDomain}/${$P}`,r={apiKey:e.apiKey,appName:t.name,v:Yr},i=HP.get(t.config.apiHost);i&&(r.eid=i);const s=t._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Oo(r).slice(1)}`}async function GP(t){const e=await BP(t),n=Zt().gapi;return H(n,t,"internal-error"),e.open({where:document.body,url:KP(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:qP,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=Jt(t,"network-request-failed"),l=Zt().setTimeout(()=>{s(o)},zP.get());function u(){Zt().clearTimeout(l),i(r)}r.ping(u).then(u,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nk="__/auth/handler",rk="emulator/auth/handler",ik=encodeURIComponent("fac");async function Pg(t,e,n,r,i,s){H(t.config.authDomain,t,"auth-domain-config-required"),H(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Yr,eventId:i};if(e instanceof pw){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",$A(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof Lo){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${ik}=${encodeURIComponent(u)}`:"";return`${sk(t)}?${Oo(l).slice(1)}${h}`}function sk({config:t}){return t.emulator?Qd(t,rk):`https://${t.authDomain}/${nk}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sc="webStorageSupport";class ok{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ww,this._completeRedirectFn=xP,this._overrideRedirectResult=PP}async _openPopup(e,n,r,i){var s;kn((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await Pg(e,n,r,Ch(),i);return ek(e,o,ef())}async _openRedirect(e,n,r,i){await this._originValidation(e);const s=await Pg(e,n,r,Ch(),i);return uP(s),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(kn(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await GP(e),r=new DP(e);return n.register("authEvent",i=>(H(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Sc,{type:Sc},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Sc];o!==void 0&&n(!!o),zt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=MP(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return cw()||iw()||Xd()}}const ak=ok;var kg="@firebase/auth",Cg="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Or,kw;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,y){function E(){}E.prototype=y.prototype,v.D=y.prototype,v.prototype=new E,v.prototype.constructor=v,v.C=function(A,k,R){for(var w=Array(arguments.length-2),Ce=2;Ce<arguments.length;Ce++)w[Ce-2]=arguments[Ce];return y.prototype[k].apply(A,w)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,y,E){E||(E=0);var A=Array(16);if(typeof y=="string")for(var k=0;16>k;++k)A[k]=y.charCodeAt(E++)|y.charCodeAt(E++)<<8|y.charCodeAt(E++)<<16|y.charCodeAt(E++)<<24;else for(k=0;16>k;++k)A[k]=y[E++]|y[E++]<<8|y[E++]<<16|y[E++]<<24;y=v.g[0],E=v.g[1],k=v.g[2];var R=v.g[3],w=y+(R^E&(k^R))+A[0]+3614090360&4294967295;y=E+(w<<7&4294967295|w>>>25),w=R+(k^y&(E^k))+A[1]+3905402710&4294967295,R=y+(w<<12&4294967295|w>>>20),w=k+(E^R&(y^E))+A[2]+606105819&4294967295,k=R+(w<<17&4294967295|w>>>15),w=E+(y^k&(R^y))+A[3]+3250441966&4294967295,E=k+(w<<22&4294967295|w>>>10),w=y+(R^E&(k^R))+A[4]+4118548399&4294967295,y=E+(w<<7&4294967295|w>>>25),w=R+(k^y&(E^k))+A[5]+1200080426&4294967295,R=y+(w<<12&4294967295|w>>>20),w=k+(E^R&(y^E))+A[6]+2821735955&4294967295,k=R+(w<<17&4294967295|w>>>15),w=E+(y^k&(R^y))+A[7]+4249261313&4294967295,E=k+(w<<22&4294967295|w>>>10),w=y+(R^E&(k^R))+A[8]+1770035416&4294967295,y=E+(w<<7&4294967295|w>>>25),w=R+(k^y&(E^k))+A[9]+2336552879&4294967295,R=y+(w<<12&4294967295|w>>>20),w=k+(E^R&(y^E))+A[10]+4294925233&4294967295,k=R+(w<<17&4294967295|w>>>15),w=E+(y^k&(R^y))+A[11]+2304563134&4294967295,E=k+(w<<22&4294967295|w>>>10),w=y+(R^E&(k^R))+A[12]+1804603682&4294967295,y=E+(w<<7&4294967295|w>>>25),w=R+(k^y&(E^k))+A[13]+4254626195&4294967295,R=y+(w<<12&4294967295|w>>>20),w=k+(E^R&(y^E))+A[14]+2792965006&4294967295,k=R+(w<<17&4294967295|w>>>15),w=E+(y^k&(R^y))+A[15]+1236535329&4294967295,E=k+(w<<22&4294967295|w>>>10),w=y+(k^R&(E^k))+A[1]+4129170786&4294967295,y=E+(w<<5&4294967295|w>>>27),w=R+(E^k&(y^E))+A[6]+3225465664&4294967295,R=y+(w<<9&4294967295|w>>>23),w=k+(y^E&(R^y))+A[11]+643717713&4294967295,k=R+(w<<14&4294967295|w>>>18),w=E+(R^y&(k^R))+A[0]+3921069994&4294967295,E=k+(w<<20&4294967295|w>>>12),w=y+(k^R&(E^k))+A[5]+3593408605&4294967295,y=E+(w<<5&4294967295|w>>>27),w=R+(E^k&(y^E))+A[10]+38016083&4294967295,R=y+(w<<9&4294967295|w>>>23),w=k+(y^E&(R^y))+A[15]+3634488961&4294967295,k=R+(w<<14&4294967295|w>>>18),w=E+(R^y&(k^R))+A[4]+3889429448&4294967295,E=k+(w<<20&4294967295|w>>>12),w=y+(k^R&(E^k))+A[9]+568446438&4294967295,y=E+(w<<5&4294967295|w>>>27),w=R+(E^k&(y^E))+A[14]+3275163606&4294967295,R=y+(w<<9&4294967295|w>>>23),w=k+(y^E&(R^y))+A[3]+4107603335&4294967295,k=R+(w<<14&4294967295|w>>>18),w=E+(R^y&(k^R))+A[8]+1163531501&4294967295,E=k+(w<<20&4294967295|w>>>12),w=y+(k^R&(E^k))+A[13]+2850285829&4294967295,y=E+(w<<5&4294967295|w>>>27),w=R+(E^k&(y^E))+A[2]+4243563512&4294967295,R=y+(w<<9&4294967295|w>>>23),w=k+(y^E&(R^y))+A[7]+1735328473&4294967295,k=R+(w<<14&4294967295|w>>>18),w=E+(R^y&(k^R))+A[12]+2368359562&4294967295,E=k+(w<<20&4294967295|w>>>12),w=y+(E^k^R)+A[5]+4294588738&4294967295,y=E+(w<<4&4294967295|w>>>28),w=R+(y^E^k)+A[8]+2272392833&4294967295,R=y+(w<<11&4294967295|w>>>21),w=k+(R^y^E)+A[11]+1839030562&4294967295,k=R+(w<<16&4294967295|w>>>16),w=E+(k^R^y)+A[14]+4259657740&4294967295,E=k+(w<<23&4294967295|w>>>9),w=y+(E^k^R)+A[1]+2763975236&4294967295,y=E+(w<<4&4294967295|w>>>28),w=R+(y^E^k)+A[4]+1272893353&4294967295,R=y+(w<<11&4294967295|w>>>21),w=k+(R^y^E)+A[7]+4139469664&4294967295,k=R+(w<<16&4294967295|w>>>16),w=E+(k^R^y)+A[10]+3200236656&4294967295,E=k+(w<<23&4294967295|w>>>9),w=y+(E^k^R)+A[13]+681279174&4294967295,y=E+(w<<4&4294967295|w>>>28),w=R+(y^E^k)+A[0]+3936430074&4294967295,R=y+(w<<11&4294967295|w>>>21),w=k+(R^y^E)+A[3]+3572445317&4294967295,k=R+(w<<16&4294967295|w>>>16),w=E+(k^R^y)+A[6]+76029189&4294967295,E=k+(w<<23&4294967295|w>>>9),w=y+(E^k^R)+A[9]+3654602809&4294967295,y=E+(w<<4&4294967295|w>>>28),w=R+(y^E^k)+A[12]+3873151461&4294967295,R=y+(w<<11&4294967295|w>>>21),w=k+(R^y^E)+A[15]+530742520&4294967295,k=R+(w<<16&4294967295|w>>>16),w=E+(k^R^y)+A[2]+3299628645&4294967295,E=k+(w<<23&4294967295|w>>>9),w=y+(k^(E|~R))+A[0]+4096336452&4294967295,y=E+(w<<6&4294967295|w>>>26),w=R+(E^(y|~k))+A[7]+1126891415&4294967295,R=y+(w<<10&4294967295|w>>>22),w=k+(y^(R|~E))+A[14]+2878612391&4294967295,k=R+(w<<15&4294967295|w>>>17),w=E+(R^(k|~y))+A[5]+4237533241&4294967295,E=k+(w<<21&4294967295|w>>>11),w=y+(k^(E|~R))+A[12]+1700485571&4294967295,y=E+(w<<6&4294967295|w>>>26),w=R+(E^(y|~k))+A[3]+2399980690&4294967295,R=y+(w<<10&4294967295|w>>>22),w=k+(y^(R|~E))+A[10]+4293915773&4294967295,k=R+(w<<15&4294967295|w>>>17),w=E+(R^(k|~y))+A[1]+2240044497&4294967295,E=k+(w<<21&4294967295|w>>>11),w=y+(k^(E|~R))+A[8]+1873313359&4294967295,y=E+(w<<6&4294967295|w>>>26),w=R+(E^(y|~k))+A[15]+4264355552&4294967295,R=y+(w<<10&4294967295|w>>>22),w=k+(y^(R|~E))+A[6]+2734768916&4294967295,k=R+(w<<15&4294967295|w>>>17),w=E+(R^(k|~y))+A[13]+1309151649&4294967295,E=k+(w<<21&4294967295|w>>>11),w=y+(k^(E|~R))+A[4]+4149444226&4294967295,y=E+(w<<6&4294967295|w>>>26),w=R+(E^(y|~k))+A[11]+3174756917&4294967295,R=y+(w<<10&4294967295|w>>>22),w=k+(y^(R|~E))+A[2]+718787259&4294967295,k=R+(w<<15&4294967295|w>>>17),w=E+(R^(k|~y))+A[9]+3951481745&4294967295,v.g[0]=v.g[0]+y&4294967295,v.g[1]=v.g[1]+(k+(w<<21&4294967295|w>>>11))&4294967295,v.g[2]=v.g[2]+k&4294967295,v.g[3]=v.g[3]+R&4294967295}r.prototype.u=function(v,y){y===void 0&&(y=v.length);for(var E=y-this.blockSize,A=this.B,k=this.h,R=0;R<y;){if(k==0)for(;R<=E;)i(this,v,R),R+=this.blockSize;if(typeof v=="string"){for(;R<y;)if(A[k++]=v.charCodeAt(R++),k==this.blockSize){i(this,A),k=0;break}}else for(;R<y;)if(A[k++]=v[R++],k==this.blockSize){i(this,A),k=0;break}}this.h=k,this.o+=y},r.prototype.v=function(){var v=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);v[0]=128;for(var y=1;y<v.length-8;++y)v[y]=0;var E=8*this.o;for(y=v.length-8;y<v.length;++y)v[y]=E&255,E/=256;for(this.u(v),v=Array(16),y=E=0;4>y;++y)for(var A=0;32>A;A+=8)v[E++]=this.g[y]>>>A&255;return v};function s(v,y){var E=l;return Object.prototype.hasOwnProperty.call(E,v)?E[v]:E[v]=y(v)}function o(v,y){this.h=y;for(var E=[],A=!0,k=v.length-1;0<=k;k--){var R=v[k]|0;A&&R==y||(E[k]=R,A=!1)}this.g=E}var l={};function u(v){return-128<=v&&128>v?s(v,function(y){return new o([y|0],0>y?-1:0)}):new o([v|0],0>v?-1:0)}function h(v){if(isNaN(v)||!isFinite(v))return p;if(0>v)return b(h(-v));for(var y=[],E=1,A=0;v>=E;A++)y[A]=v/E|0,E*=4294967296;return new o(y,0)}function f(v,y){if(v.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(v.charAt(0)=="-")return b(f(v.substring(1),y));if(0<=v.indexOf("-"))throw Error('number format error: interior "-" character');for(var E=h(Math.pow(y,8)),A=p,k=0;k<v.length;k+=8){var R=Math.min(8,v.length-k),w=parseInt(v.substring(k,k+R),y);8>R?(R=h(Math.pow(y,R)),A=A.j(R).add(h(w))):(A=A.j(E),A=A.add(h(w)))}return A}var p=u(0),g=u(1),S=u(16777216);t=o.prototype,t.m=function(){if(C(this))return-b(this).m();for(var v=0,y=1,E=0;E<this.g.length;E++){var A=this.i(E);v+=(0<=A?A:4294967296+A)*y,y*=4294967296}return v},t.toString=function(v){if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(P(this))return"0";if(C(this))return"-"+b(this).toString(v);for(var y=h(Math.pow(v,6)),E=this,A="";;){var k=D(E,y).g;E=T(E,k.j(y));var R=((0<E.g.length?E.g[0]:E.h)>>>0).toString(v);if(E=k,P(E))return R+A;for(;6>R.length;)R="0"+R;A=R+A}},t.i=function(v){return 0>v?0:v<this.g.length?this.g[v]:this.h};function P(v){if(v.h!=0)return!1;for(var y=0;y<v.g.length;y++)if(v.g[y]!=0)return!1;return!0}function C(v){return v.h==-1}t.l=function(v){return v=T(this,v),C(v)?-1:P(v)?0:1};function b(v){for(var y=v.g.length,E=[],A=0;A<y;A++)E[A]=~v.g[A];return new o(E,~v.h).add(g)}t.abs=function(){return C(this)?b(this):this},t.add=function(v){for(var y=Math.max(this.g.length,v.g.length),E=[],A=0,k=0;k<=y;k++){var R=A+(this.i(k)&65535)+(v.i(k)&65535),w=(R>>>16)+(this.i(k)>>>16)+(v.i(k)>>>16);A=w>>>16,R&=65535,w&=65535,E[k]=w<<16|R}return new o(E,E[E.length-1]&-2147483648?-1:0)};function T(v,y){return v.add(b(y))}t.j=function(v){if(P(this)||P(v))return p;if(C(this))return C(v)?b(this).j(b(v)):b(b(this).j(v));if(C(v))return b(this.j(b(v)));if(0>this.l(S)&&0>v.l(S))return h(this.m()*v.m());for(var y=this.g.length+v.g.length,E=[],A=0;A<2*y;A++)E[A]=0;for(A=0;A<this.g.length;A++)for(var k=0;k<v.g.length;k++){var R=this.i(A)>>>16,w=this.i(A)&65535,Ce=v.i(k)>>>16,on=v.i(k)&65535;E[2*A+2*k]+=w*on,_(E,2*A+2*k),E[2*A+2*k+1]+=R*on,_(E,2*A+2*k+1),E[2*A+2*k+1]+=w*Ce,_(E,2*A+2*k+1),E[2*A+2*k+2]+=R*Ce,_(E,2*A+2*k+2)}for(A=0;A<y;A++)E[A]=E[2*A+1]<<16|E[2*A];for(A=y;A<2*y;A++)E[A]=0;return new o(E,0)};function _(v,y){for(;(v[y]&65535)!=v[y];)v[y+1]+=v[y]>>>16,v[y]&=65535,y++}function I(v,y){this.g=v,this.h=y}function D(v,y){if(P(y))throw Error("division by zero");if(P(v))return new I(p,p);if(C(v))return y=D(b(v),y),new I(b(y.g),b(y.h));if(C(y))return y=D(v,b(y)),new I(b(y.g),y.h);if(30<v.g.length){if(C(v)||C(y))throw Error("slowDivide_ only works with positive integers.");for(var E=g,A=y;0>=A.l(v);)E=M(E),A=M(A);var k=F(E,1),R=F(A,1);for(A=F(A,2),E=F(E,2);!P(A);){var w=R.add(A);0>=w.l(v)&&(k=k.add(E),R=w),A=F(A,1),E=F(E,1)}return y=T(v,k.j(y)),new I(k,y)}for(k=p;0<=v.l(y);){for(E=Math.max(1,Math.floor(v.m()/y.m())),A=Math.ceil(Math.log(E)/Math.LN2),A=48>=A?1:Math.pow(2,A-48),R=h(E),w=R.j(y);C(w)||0<w.l(v);)E-=A,R=h(E),w=R.j(y);P(R)&&(R=g),k=k.add(R),v=T(v,w)}return new I(k,v)}t.A=function(v){return D(this,v).h},t.and=function(v){for(var y=Math.max(this.g.length,v.g.length),E=[],A=0;A<y;A++)E[A]=this.i(A)&v.i(A);return new o(E,this.h&v.h)},t.or=function(v){for(var y=Math.max(this.g.length,v.g.length),E=[],A=0;A<y;A++)E[A]=this.i(A)|v.i(A);return new o(E,this.h|v.h)},t.xor=function(v){for(var y=Math.max(this.g.length,v.g.length),E=[],A=0;A<y;A++)E[A]=this.i(A)^v.i(A);return new o(E,this.h^v.h)};function M(v){for(var y=v.g.length+1,E=[],A=0;A<y;A++)E[A]=v.i(A)<<1|v.i(A-1)>>>31;return new o(E,v.h)}function F(v,y){var E=y>>5;y%=32;for(var A=v.g.length-E,k=[],R=0;R<A;R++)k[R]=0<y?v.i(R+E)>>>y|v.i(R+E+1)<<32-y:v.i(R+E);return new o(k,v.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,kw=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Or=o}).apply(typeof Ng<"u"?Ng:typeof self<"u"?self:typeof window<"u"?window:{});var Pa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new Mw("Invalid base64 string: "+s):s}}(e);return new He(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new He(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return se(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}He.EMPTY_BYTE_STRING=new He("");const Nk=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function dr(t){if(ae(!!t),typeof t=="string"){let e=0;const n=Nk.exec(t);if(ae(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Pe(t.seconds),nanos:Pe(t.nanos)}}function Pe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Wr(t){return typeof t=="string"?He.fromBase64String(t):He.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft{constructor(e){this.value=e}static empty(){return new ft({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!Ya(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=qs(n)}setAll(e){let n=ze.emptyPath(),r={},i=[];e.forEach((o,l)=>{if(!n.isImmediateParentOf(l)){const u=this.getFieldsMap(n);this.applyChanges(u,r,i),r={},i=[],n=l.popLast()}o?r[l.lastSegment()]=qs(o):i.push(l.lastSegment())});const s=this.getFieldsMap(n);this.applyChanges(s,r,i)}delete(e){const n=this.field(e.popLast());Ya(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return rn(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let i=n.mapValue.fields[e.get(r)];Ya(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=i),n=i}return n.mapValue.fields}applyChanges(e,n,r){Jr(n,(i,s)=>e[i]=s);for(const i of r)delete e[i]}clone(){return new ft(qs(this.value))}}function Uw(t){const e=[];return Jr(t.fields,(n,r)=>{const i=new ze([n]);if(Ya(r)){const s=Uw(r.mapValue).fields;if(s.length===0)e.push(i);else for(const o of s)e.push(i.child(o))}else e.push(i)}),new Et(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qk=new Ee(q.comparator);function xn(){return Qk}const Gw=new Ee(q.comparator);function Ds(...t){let e=Gw;for(const n of t)e=e.insert(n.key,n);return e}function Qw(t){let e=Gw;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function xr(){return Ks()}function Yw(){return Ks()}function Ks(){return new es(t=>t.toString(),(t,e)=>t.isEqual(e))}const Yk=new Ee(q.comparator),Xk=new We(q.comparator);function Z(...t){let e=Xk;for(const n of t)e=e.add(n);return e}const Jk=new We(se);function Zk(){return Jk}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mf{constructor(){this.Tr=new We(Le.Er),this.dr=new We(Le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,n){const r=new Le(e,n);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Vr(new Le(e,n))}mr(e,n){e.forEach(r=>this.removeReference(r,n))}gr(e){const n=new q(new fe([])),r=new Le(n,e),i=new Le(n,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const n=new q(new fe([])),r=new Le(n,e),i=new Le(n,e+1);let s=Z();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new Le(e,0),r=this.Tr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class Le{constructor(e,n){this.key=e,this.wr=n}static Er(e,n){return q.comparator(e.key,n.key)||se(e.wr,n.wr)}static Ar(e,n){return se(e.wr,n.wr)||q.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QC{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return MA()?8:Ck(rt())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new GC;return this.Xi(e,n,o).next(l=>{if(s.result=l,this.zi)return this.es(e,n,o,l.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(Is()<=ee.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",oi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),L.resolve()):(Is()<=ee.DEBUG&&W("QueryEngine","Query:",oi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(Is()<=ee.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",oi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,en(n))):L.resolve())}Yi(e,n){if($g(n))return L.resolve(null);let r=en(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Uh(n,null,"F"),r=en(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=Z(...s);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(n,l);return this.ns(n,h,o,u.readTime)?this.Yi(e,Uh(n,null,"F")):this.rs(e,h,n,u)}))})))}Zi(e,n,r,i){return $g(n)||i.isEqual(Q.min())?L.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?L.resolve(null):(Is()<=ee.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),oi(n)),this.rs(e,o,n,Ak(i,-1)).next(l=>l))})}ts(e,n){let r=new We(Kw(e));return n.forEach((i,s)=>{du(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return Is()<=ee.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",oi(n)),this.Ji.getDocumentsMatchingQuery(e,n,hr.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e){this.comparator=e?(n,r)=>e(n,r)||q.comparator(n.key,r.key):(n,r)=>q.comparator(n.key,r.key),this.keyedMap=Ds(),this.sortedSet=new Ee(this.comparator)}static emptySet(e){return new Di(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof Di)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,s=r.getNext().key;if(!i.isEqual(s))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iy{constructor(){this.W_=new Ee(q.comparator)}track(e){const n=e.doc.key,r=this.W_.get(n);r?e.type!==0&&r.type===3?this.W_=this.W_.insert(n,e):e.type===3&&r.type!==1?this.W_=this.W_.insert(n,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.W_=this.W_.insert(n,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.W_=this.W_.insert(n,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.W_=this.W_.remove(n):e.type===1&&r.type===2?this.W_=this.W_.insert(n,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.W_=this.W_.insert(n,{type:2,doc:e.doc}):K():this.W_=this.W_.insert(n,e)}G_(){const e=[];return this.W_.inorderTraversal((n,r)=>{e.push(r)}),e}}class qi{constructor(e,n,r,i,s,o,l,u,h){this.query=e,this.docs=n,this.oldDocs=r,this.docChanges=i,this.mutatedKeys=s,this.fromCache=o,this.syncStateChanged=l,this.excludesMetadataChanges=u,this.hasCachedResults=h}static fromInitialDocuments(e,n,r,i,s){const o=[];return n.forEach(l=>{o.push({type:0,doc:l})}),new qi(e,n,Di.emptySet(n),o,r,i,!0,!1,s)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&hu(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,r=e.docChanges;if(n.length!==r.length)return!1;for(let i=0;i<n.length;i++)if(n[i].type!==r[i].type||!n[i].doc.isEqual(r[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S1{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class R1{constructor(){this.queries=sy(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(n,r){const i=Y(n),s=i.queries;i.queries=sy(),s.forEach((o,l)=>{for(const u of l.j_)u.onError(r)})})(this,new z(V.ABORTED,"Firestore shutting down"))}}function sy(){return new es(t=>Hw(t),hu)}async function AE(t,e){const n=Y(t);let r=3;const i=e.query;let s=n.queries.get(i);s?!s.H_()&&e.J_()&&(r=2):(s=new S1,r=e.J_()?0:1);try{switch(r){case 0:s.z_=await n.onListen(i,!0);break;case 1:s.z_=await n.onListen(i,!1);break;case 2:await n.onFirstRemoteStoreListen(i)}}catch(o){const l=If(o,`Initialization of query '${oi(e.query)}' failed`);return void e.onError(l)}n.queries.set(i,s),s.j_.push(e),e.Z_(n.onlineState),s.z_&&e.X_(s.z_)&&Af(n)}async function SE(t,e){const n=Y(t),r=e.query;let i=3;const s=n.queries.get(r);if(s){const o=s.j_.indexOf(e);o>=0&&(s.j_.splice(o,1),s.j_.length===0?i=e.J_()?0:1:!s.H_()&&e.J_()&&(i=2))}switch(i){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function P1(t,e){const n=Y(t);let r=!1;for(const i of e){const s=i.query,o=n.queries.get(s);if(o){for(const l of o.j_)l.X_(i)&&(r=!0);o.z_=i}}r&&Af(n)}function k1(t,e,n){const r=Y(t),i=r.queries.get(e);if(i)for(const s of i.j_)s.onError(n);r.queries.delete(e)}function Af(t){t.Y_.forEach(e=>{e.next()})}var Wh,oy;(oy=Wh||(Wh={})).ea="default",oy.Cache="cache";class RE{constructor(e,n,r){this.query=e,this.ta=n,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=r||{}}X_(e){if(!this.options.includeMetadataChanges){const r=[];for(const i of e.docChanges)i.type!==3&&r.push(i);e=new qi(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.na?this.ia(e)&&(this.ta.next(e),n=!0):this.sa(e,this.onlineState)&&(this.oa(e),n=!0),this.ra=e,n}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let n=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),n=!0),n}sa(e,n){if(!e.fromCache||!this.J_())return!0;const r=n!=="Offline";return(!this.options._a||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const n=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}oa(e){e=qi.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Wh.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Hi(He.fromBase64String(e))}catch(n){throw new z(V.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Hi(He.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fx(t){t=nn(t,ut);const e=nn(t.firestore,Hr);return Q1(Rf(e),t._key).then(n=>ZE(e,t,n))}class XE extends ux{constructor(e){super(),this.firestore=e}convertBytes(e){return new Hi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new ut(this.firestore,null,n)}}function JE(t,e,n,...r){t=nn(t,ut);const i=nn(t.firestore,Hr),s=Nf(i);let o;return o=typeof(e=we(e))=="string"||e instanceof Eu?ix(s,"updateDoc",t._key,e,n,r):rx(s,"updateDoc",t._key,e),Ff(i,[o.toMutation(t._key,jt.exists(!0))])}function px(t){return Ff(nn(t.firestore,Hr),[new hf(t._key,jt.none())])}function mx(t,e){const n=nn(t.firestore,Hr),r=Ro(t),i=cx(t.converter,e);return Ff(n,[nx(Nf(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,jt.exists(!1))]).then(()=>r)}function jl(t,...e){var n,r,i;t=we(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||my(e[o])||(s=e[o],o++);const l={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(my(e[o])){const p=e[o];e[o]=(n=p.next)===null||n===void 0?void 0:n.bind(p),e[o+1]=(r=p.error)===null||r===void 0?void 0:r.bind(p),e[o+2]=(i=p.complete)===null||i===void 0?void 0:i.bind(p)}let u,h,f;if(t instanceof ut)h=nn(t.firestore,Hr),f=cu(t._key.path),u={next:p=>{e[o]&&e[o](ZE(h,t,p))},error:e[o+1],complete:e[o+2]};else{const p=nn(t,ei);h=nn(p.firestore,Hr),f=p._query;const g=new XE(h);u={next:S=>{e[o]&&e[o](new hx(h,g,p,S))},error:e[o+1],complete:e[o+2]},lx(t._query)}return function(g,S,P,C){const b=new VE(C),T=new RE(S,b,P);return g.asyncQueue.enqueueAndForget(async()=>AE(await Kh(g),T)),()=>{b.Za(),g.asyncQueue.enqueueAndForget(async()=>SE(await Kh(g),T))}}(Rf(h),f,l,u)}function Ff(t,e){return function(r,i){const s=new or;return r.asyncQueue.enqueueAndForget(async()=>U1(await G1(r),i,s)),s.promise}(Rf(t),e)}function ZE(t,e,n){const r=n.docs.get(e._key),i=new XE(t);return new YE(t,i,e._key,r,new bs(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){Ji=i})(Yr),jr(new cr("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Hr(new yk(r.getProvider("auth-internal")),new Ek(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new z(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wo(h.options.projectId,f)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),Xt(Dg,"4.7.3",e),Xt(Dg,"4.7.3","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se extends sn{constructor(e,n,r=0){super(xc(e),`Firebase Storage: ${n} (${xc(e)})`),this.status_=r,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,Se.prototype)}get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return xc(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var Ae;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(Ae||(Ae={}));function xc(t){return"storage/"+t}function jf(){const t="An unknown error occurred, please check the error payload for server response.";return new Se(Ae.UNKNOWN,t)}function _x(t){return new Se(Ae.OBJECT_NOT_FOUND,"Object '"+t+"' does not exist.")}function vx(t){return new Se(Ae.QUOTA_EXCEEDED,"Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function wx(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new Se(Ae.UNAUTHENTICATED,t)}function Ex(){return new Se(Ae.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function Tx(t){return new Se(Ae.UNAUTHORIZED,"User does not have permission to access '"+t+"'.")}function Ix(){return new Se(Ae.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function Ax(){return new Se(Ae.CANCELED,"User canceled the upload/download.")}function Sx(t){return new Se(Ae.INVALID_URL,"Invalid URL '"+t+"'.")}function Rx(t){return new Se(Ae.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function Px(){return new Se(Ae.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+t0+"' property when initializing the app?")}function kx(){return new Se(Ae.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function Cx(){return new Se(Ae.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function xx(t){return new Se(Ae.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function Qh(t){return new Se(Ae.INVALID_ARGUMENT,t)}function n0(){return new Se(Ae.APP_DELETED,"The Firebase app was deleted.")}function Nx(t){return new Se(Ae.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Qs(t,e){return new Se(Ae.INVALID_FORMAT,"String does not match format '"+t+"': "+e)}function As(t){throw new Se(Ae.INTERNAL_ERROR,"Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Tt.makeFromUrl(e,n)}catch{return new Tt(e,"")}if(r.path==="")return r;throw Rx(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(D){D.path.charAt(D.path.length-1)==="/"&&(D.path_=D.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+i+o,"i"),u={bucket:1,path:3};function h(D){D.path_=decodeURIComponent(D.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",S=new RegExp(`^https?://${p}/${f}/b/${i}/o${g}`,"i"),P={bucket:1,path:3},C=n===e0?"(?:storage.googleapis.com|storage.cloud.google.com)":n,b="([^?#]*)",T=new RegExp(`^https?://${C}/${i}/${b}`,"i"),I=[{regex:l,indices:u,postModify:s},{regex:S,indices:P,postModify:h},{regex:T,indices:{bucket:1,path:2},postModify:h}];for(let D=0;D<I.length;D++){const M=I[D],F=M.regex.exec(e);if(F){const v=F[M.indices.bucket];let y=F[M.indices.path];y||(y=""),r=new Tt(v,y),M.postModify(r);break}}if(r==null)throw Sx(e);return r}}class Dx{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ox(t,e,n){let r=1,i=null,s=null,o=!1,l=0;function u(){return l===2}let h=!1;function f(...b){h||(h=!0,e.apply(null,b))}function p(b){i=setTimeout(()=>{i=null,t(S,u())},b)}function g(){s&&clearTimeout(s)}function S(b,...T){if(h){g();return}if(b){g(),f.call(null,b,...T);return}if(u()||o){g(),f.call(null,b,...T);return}r<64&&(r*=2);let I;l===1?(l=2,I=0):I=(r+Math.random())*1e3,p(I)}let P=!1;function C(b){P||(P=!0,g(),!h&&(i!==null?(b||(l=2),clearTimeout(i),p(0)):b||(l=1)))}return p(0),s=setTimeout(()=>{o=!0,C(!0)},n),C}function bx(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wx(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function qx(...t){const e=Wx();if(e!==void 0){const n=new e;for(let r=0;r<t.length;r++)n.append(t[r]);return n.getBlob()}else{if(zf())return new Blob(t);throw new Se(Ae.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function Hx(t,e,n){return t.webkitSlice?t.webkitSlice(e,n):t.mozSlice?t.mozSlice(e,n):t.slice?t.slice(e,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(e,n){let r=0,i="";_y(e)?(this.data_=e,r=e.size,i=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),r=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),r=e.length),this.size_=r,this.type_=i}size(){return this.size_}type(){return this.type_}slice(e,n){if(_y(this.data_)){const r=this.data_,i=Hx(r,e,n);return i===null?null:new Hn(i)}else{const r=new Uint8Array(this.data_.buffer,e,n-e);return new Hn(r,!0)}}static getBlob(...e){if(zf()){const n=e.map(r=>r instanceof Hn?r.data_:r);return new Hn(qx.apply(null,n))}else{const n=e.map(o=>Bf(o)?Gx(Gt.RAW,o).data:o.data_);let r=0;n.forEach(o=>{r+=o.byteLength});const i=new Uint8Array(r);let s=0;return n.forEach(o=>{for(let l=0;l<o.length;l++)i[s++]=o[l]}),new Hn(i,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g0="storage";function IN(t,e,n){return t=we(t),gN(t,e,n)}function AN(t){return t=we(t),yN(t)}function SN(t,e){return t=we(t),EN(t,e)}function y0(t=su(),e){t=we(t);const r=iu(t,g0).getImmediate({identifier:e}),i=jv("storage");return i&&RN(r,...i),r}function RN(t,e,n,r={}){TN(t,e,n,r)}function PN(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new Wf(n,r,i,e,Yr)}function kN(){jr(new cr(g0,PN,"PUBLIC").setMultipleInstances(!0)),Xt(Ey,Ty,""),Xt(Ey,Ty,"esm2017")}kN();const el={apiKey:"AIzaSyCR-axayENUg4FFb4jj0uVW2BnfwQ5EiXY",authDomain:"mitienda-c2609.firebaseapp.com",databaseURL:"https://mitienda-c2609-default-rtdb.firebaseio.com",projectId:"mitienda-c2609",storageBucket:"mitienda-c2609.firebasestorage.app",messagingSenderId:"536746062790",appId:"1:536746062790:web:cd39eb0057aac14c6538c7"},qf=Hd(el);FE(qf);Pw(qf);y0(qf);const Ki=te.createContext(null),Ti=({message:t,onConfirm:e,onCancel:n,type:r})=>t?N.jsx("div",{className:"fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50 p-4",children:N.jsxs("div",{className:"bg-white rounded-lg shadow-xl p-6 max-w-sm w-full text-center",children:[N.jsx("p",{className:"text-lg font-semibold mb-4",children:t}),r==="confirm"?N.jsxs("div",{className:"flex justify-around gap-4",children:[N.jsx("button",{onClick:e,className:"px-5 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors shadow-md",children:"Confirmar"}),N.jsx("button",{onClick:n,className:"px-5 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 transition-colors shadow-md",children:"Cancelar"})]}):N.jsx("button",{onClick:e,className:"px-5 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors shadow-md",children:"OK"})]})}):null,Hf=()=>{const[t,e]=te.useState({message:"",onConfirm:null,onCancel:null,type:"alert"});return{modalState:t,showAlert:(s,o=()=>e({message:""}))=>{e({message:s,onConfirm:o,onCancel:null,type:"alert"})},showConfirm:(s,o,l=()=>e({message:""}))=>{e({message:s,onConfirm:o,onCancel:l,type:"confirm"})},closeModal:()=>e({message:""})}},CN=()=>{const[t,e]=te.useState(""),[n,r]=te.useState(""),[i,s]=te.useState(!1),{auth:o,showAlert:l}=te.useContext(Ki),u=async h=>{h.preventDefault(),s(!0);try{await eP(o,t,n)}catch(f){console.error("Error al iniciar sesión:",f),l(`Error al iniciar sesión: ${f.message}`)}finally{s(!1)}};return N.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100 p-4",children:N.jsxs("div",{className:"bg-white p-8 rounded-lg shadow-xl w-full max-w-md",children:[N.jsx("h2",{className:"text-3xl font-bold text-center text-gray-800 mb-8",children:"Iniciar Sesión Admin"}),N.jsxs("form",{onSubmit:u,className:"space-y-6",children:[N.jsxs("div",{children:[N.jsx("label",{htmlFor:"email",className:"block text-sm font-medium text-gray-700 mb-1",children:"Correo Electrónico"}),N.jsx("input",{type:"email",id:"email",className:"w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 transition-all",placeholder:"admin@example.com",value:t,onChange:h=>e(h.target.value),required:!0})]}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"password",className:"block text-sm font-medium text-gray-700 mb-1",children:"Contraseña"}),N.jsx("input",{type:"password",id:"password",className:"w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 transition-all",placeholder:"********",value:n,onChange:h=>r(h.target.value),required:!0,autoComplete:"current-password"})]}),N.jsx("button",{type:"submit",className:"w-full bg-blue-600 text-white py-3 rounded-md font-semibold hover:bg-blue-700 transition-colors shadow-lg disabled:opacity-50",disabled:i,children:i?"Iniciando sesión...":"Iniciar Sesión"})]}),N.jsx("p",{className:"mt-6 text-center text-sm text-gray-600",children:"Usa un correo y contraseña de administrador configurados en Firebase Auth."})]})})},xN=()=>{const{db:t}=te.useContext(Ki),[e,n]=te.useState({totalProducts:0,totalOrders:0,pendingOrders:0,lowStockProducts:0}),[r,i]=te.useState(!0),[s,o]=te.useState(null);return te.useEffect(()=>{if(!t)return;(async()=>{try{const u=So(t,"productos"),h=jl(u,g=>{const S=g.docs.map(C=>C.data()),P=S.filter(C=>C.cantidadInventario<10).length;n(C=>({...C,totalProducts:S.length,lowStockProducts:P}))},g=>{console.error("Error fetching products for dashboard:",g),o("Error al cargar datos de productos.")}),f=So(t,"orders"),p=jl(f,g=>{const S=g.docs.map(C=>C.data()),P=S.filter(C=>C.estado==="pendiente"||C.estado==="procesando").length;n(C=>({...C,totalOrders:S.length,pendingOrders:P}))},g=>{console.error("Error fetching orders for dashboard:",g),o("Error al cargar datos de órdenes.")});return i(!1),()=>{h(),p()}}catch(u){console.error("Error general al obtener el resumen del dashboard:",u),o("Error al cargar el resumen del dashboard."),i(!1)}})()},[t]),r?N.jsx("div",{className:"text-center p-8",children:"Cargando resumen..."}):s?N.jsxs("div",{className:"text-center p-8 text-red-600",children:["Error: ",s]}):N.jsxs("div",{className:"p-6 bg-gray-50 min-h-screen",children:[N.jsx("h1",{className:"text-4xl font-extrabold text-gray-900 mb-8 text-center",children:"Resumen del Dashboard"}),N.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",children:[N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center text-center",children:[N.jsx("div",{className:"text-5xl font-bold text-blue-600 mb-2",children:e.totalProducts}),N.jsx("p",{className:"text-lg text-gray-700",children:"Productos Totales"})]}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center text-center",children:[N.jsx("div",{className:"text-5xl font-bold text-green-600 mb-2",children:e.totalOrders}),N.jsx("p",{className:"text-lg text-gray-700",children:"Órdenes Totales"})]}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center text-center",children:[N.jsx("div",{className:"text-5xl font-bold text-yellow-600 mb-2",children:e.pendingOrders}),N.jsx("p",{className:"text-lg text-gray-700",children:"Órdenes Pendientes"})]}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center text-center",children:[N.jsx("div",{className:"text-5xl font-bold text-red-600 mb-2",children:e.lowStockProducts}),N.jsx("p",{className:"text-lg text-gray-700",children:"Productos con Poco Stock"})]})]})]})},NN=()=>{const{db:t,storage:e}=te.useContext(Ki),{showAlert:n,showConfirm:r,closeModal:i,modalState:s}=Hf(),[o,l]=te.useState([]),[u,h]=te.useState(!0),[f,p]=te.useState(null),[g,S]=te.useState(!1),[P,C]=te.useState(!1),[b,T]=te.useState(null),[_,I]=te.useState({nombre:"",descripcion:"",precio:"",cantidadInventario:"",categoria:"",imagen:null,imagenUrl:""});te.useEffect(()=>{if(!t)return;const R=KE(So(t,"productos"),GE("fechaCreacion","desc")),w=jl(R,Ce=>{const on=Ce.docs.map(Dn=>({id:Dn.id,...Dn.data()}));l(on),h(!1)},Ce=>{console.error("Error al obtener productos:",Ce),p("Error al cargar productos."),h(!1)});return()=>w()},[t]);const D=()=>{I({nombre:"",descripcion:"",precio:"",cantidadInventario:"",categoria:"",imagen:null,imagenUrl:""}),S(!1),C(!1),T(null)},M=R=>{const{name:w,value:Ce}=R.target;I({..._,[w]:Ce})},F=R=>{R.target.files[0]&&I({..._,imagen:R.target.files[0]})},v=async R=>{if(!R)return null;const w=SN(e,`product_images/${R.name}_${Date.now()}`);return await IN(w,R),await AN(w)},y=async R=>{R.preventDefault(),h(!0);try{let w="";_.imagen&&(w=await v(_.imagen)),await mx(So(t,"productos"),{nombre:_.nombre,descripcion:_.descripcion,precio:parseFloat(_.precio),cantidadInventario:parseInt(_.cantidadInventario,10),categoria:_.categoria,imagenUrl:w,fechaCreacion:new Date,ultimaActualizacion:new Date,activo:!0}),n("Producto añadido con éxito."),D()}catch(w){console.error("Error añadiendo producto:",w),n(`Error al añadir producto: ${w.message}`)}finally{h(!1)}},E=R=>{C(!0),T(R),I({nombre:R.nombre,descripcion:R.descripcion,precio:R.precio,cantidadInventario:R.cantidadInventario,categoria:R.categoria,imagen:null,imagenUrl:R.imagenUrl})},A=async R=>{R.preventDefault(),h(!0);try{let w=_.imagenUrl;_.imagen&&(w=await v(_.imagen));const Ce=Ro(t,"productos",b.id);await JE(Ce,{nombre:_.nombre,descripcion:_.descripcion,precio:parseFloat(_.precio),cantidadInventario:parseInt(_.cantidadInventario,10),categoria:_.categoria,imagenUrl:w,ultimaActualizacion:new Date}),n("Producto actualizado con éxito."),D()}catch(w){console.error("Error actualizando producto:",w),n(`Error al actualizar producto: ${w.message}`)}finally{h(!1)}},k=R=>{r("¿Estás seguro de que quieres eliminar este producto?",async()=>{h(!0);try{await px(Ro(t,"productos",R)),n("Producto eliminado con éxito.")}catch(w){console.error("Error eliminando producto:",w),n(`Error al eliminar producto: ${w.message}`)}finally{h(!1),i()}},i)};return u?N.jsx("div",{className:"text-center p-8",children:"Cargando productos..."}):f?N.jsxs("div",{className:"text-center p-8 text-red-600",children:["Error: ",f]}):N.jsxs("div",{className:"p-6 bg-gray-50 min-h-screen",children:[N.jsx("h1",{className:"text-4xl font-extrabold text-gray-900 mb-8 text-center",children:"Gestión de Productos"}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg mb-8",children:[N.jsx("button",{onClick:()=>{S(!0)},className:"bg-green-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-green-700 transition-colors shadow-md mb-6",children:"Añadir Nuevo Producto"}),(g||P)&&N.jsxs("form",{onSubmit:P?A:y,className:"space-y-4",children:[N.jsx("h2",{className:"text-2xl font-bold text-gray-800 mb-4",children:P?"Editar Producto":"Añadir Nuevo Producto"}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"nombre",className:"block text-sm font-medium text-gray-700",children:"Nombre"}),N.jsx("input",{type:"text",id:"nombre",name:"nombre",value:_.nombre,onChange:M,required:!0,className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"})]}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"descripcion",className:"block text-sm font-medium text-gray-700",children:"Descripción"}),N.jsx("textarea",{id:"descripcion",name:"descripcion",value:_.descripcion,onChange:M,className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"})]}),N.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[N.jsxs("div",{children:[N.jsx("label",{htmlFor:"precio",className:"block text-sm font-medium text-gray-700",children:"Precio"}),N.jsx("input",{type:"number",id:"precio",name:"precio",value:_.precio,onChange:M,required:!0,step:"0.01",className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"})]}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"cantidadInventario",className:"block text-sm font-medium text-gray-700",children:"Cantidad en Inventario"}),N.jsx("input",{type:"number",id:"cantidadInventario",name:"cantidadInventario",value:_.cantidadInventario,onChange:M,required:!0,className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"})]})]}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"categoria",className:"block text-sm font-medium text-gray-700",children:"Categoría"}),N.jsx("input",{type:"text",id:"categoria",name:"categoria",value:_.categoria,onChange:M,className:"w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"})]}),N.jsxs("div",{children:[N.jsx("label",{htmlFor:"imagen",className:"block text-sm font-medium text-gray-700",children:"Imagen del Producto"}),N.jsx("input",{type:"file",id:"imagen",name:"imagen",onChange:F,className:"w-full text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"}),_.imagenUrl&&N.jsxs("div",{className:"mt-2",children:[N.jsx("p",{className:"text-sm text-gray-600",children:"Imagen actual:"}),N.jsx("img",{src:_.imagenUrl,alt:"Producto",className:"w-24 h-24 object-cover rounded-md mt-1 shadow"})]})]}),N.jsxs("div",{className:"flex justify-end gap-4",children:[N.jsx("button",{type:"button",onClick:D,className:"px-6 py-3 bg-gray-300 text-gray-800 rounded-md font-semibold hover:bg-gray-400 transition-colors shadow-md",children:"Cancelar"}),N.jsx("button",{type:"submit",className:"px-6 py-3 bg-blue-600 text-white rounded-md font-semibold hover:bg-blue-700 transition-colors shadow-md disabled:opacity-50",disabled:u,children:P?"Actualizar Producto":"Añadir Producto"})]})]})]}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg",children:[N.jsx("h2",{className:"text-2xl font-bold text-gray-800 mb-4",children:"Lista de Productos"}),o.length===0?N.jsx("p",{className:"text-gray-600",children:"No hay productos registrados."}):N.jsx("div",{className:"overflow-x-auto",children:N.jsxs("table",{className:"min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden",children:[N.jsx("thead",{className:"bg-gray-50",children:N.jsxs("tr",{children:[N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Imagen"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Nombre"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Precio"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Stock"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Categoría"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Acciones"})]})}),N.jsx("tbody",{className:"bg-white divide-y divide-gray-200",children:o.map(R=>N.jsxs("tr",{children:[N.jsx("td",{className:"px-6 py-4 whitespace-nowrap",children:R.imagenUrl?N.jsx("img",{src:R.imagenUrl,alt:R.nombre,className:"w-16 h-16 object-cover rounded-md shadow"}):N.jsx("div",{className:"w-16 h-16 bg-gray-200 rounded-md flex items-center justify-center text-gray-500 text-xs",children:"Sin imagen"})}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900",children:R.nombre}),N.jsxs("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:["$",R.precio.toFixed(2)]}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:R.cantidadInventario}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:R.categoria||"N/A"}),N.jsxs("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium",children:[N.jsx("button",{onClick:()=>E(R),className:"text-blue-600 hover:text-blue-900 mr-4 transition-colors",children:"Editar"}),N.jsx("button",{onClick:()=>k(R.id),className:"text-red-600 hover:text-red-900 transition-colors",children:"Eliminar"})]})]},R.id))})]})})]}),N.jsx(Ti,{...s})]})},DN=()=>{const{db:t}=te.useContext(Ki),{showAlert:e,modalState:n}=Hf(),[r,i]=te.useState([]),[s,o]=te.useState(!0),[l,u]=te.useState(null),h=["pendiente","procesando","enviado","entregado","cancelado"];te.useEffect(()=>{if(console.log("Orders.jsx: useEffect se ejecutó."),!t){console.log("Orders.jsx: db no está disponible."),u("La base de datos no está inicializada."),o(!1);return}console.log("Orders.jsx: Intentando obtener órdenes de Firestore...");const p=KE(So(t,"orders"),GE("fechaOrden","desc")),g=jl(p,S=>{const P=S.docs.map(C=>{const b=C.data();let T=b.estado;if(typeof T=="object"&&T!==null){console.warn(`Orders.jsx: 'estado' para la orden ${C.id} es un objeto. Intentando analizar o establecer un valor predeterminado.`);const _=h.find(I=>Object.keys(T).includes(I));_?(T=_,console.log(`Orders.jsx: 'estado' analizado de objeto a cadena: ${T}`)):(T="desconocido",console.warn(`Orders.jsx: No se encontró una clave de estado válida en el objeto para la orden ${C.id}. Se establece 'desconocido'.`))}else typeof T!="string"&&(console.warn(`Orders.jsx: 'estado' para la orden ${C.id} no es una cadena ni un objeto. Tipo: ${typeof T}. Se establece 'desconocido'.`),T="desconocido");return{id:C.id,...b,estado:T}});console.log("Orders.jsx: Datos de órdenes recibidos y procesados:",P),i(P),o(!1)},S=>{console.error("Orders.jsx: Error al obtener órdenes:",S),u("Error al cargar órdenes: "+S.message),o(!1)});return()=>{console.log("Orders.jsx: Limpiando suscripción de onSnapshot."),g()}},[t]);const f=async(p,g)=>{o(!0),console.log(`Intentando actualizar la orden ${p} a estado: ${g}`);try{const S=Ro(t,"orders",p);await JE(S,{estado:g}),e("Estado de la orden actualizado con éxito."),console.log(`Orden ${p} actualizada a estado: ${g}`)}catch(S){console.error("Error actualizando estado de la orden:",S),e(`Error al actualizar estado: ${S.message}`)}finally{o(!1)}};return s?N.jsx("div",{className:"text-center p-8",children:"Cargando órdenes..."}):l?N.jsxs("div",{className:"text-center p-8 text-red-600",children:["Error: ",l]}):N.jsxs("div",{className:"p-6 bg-gray-50 min-h-screen",children:[N.jsx("h1",{className:"text-4xl font-extrabold text-gray-900 mb-8 text-center",children:"Gestión de Órdenes"}),N.jsxs("div",{className:"bg-white p-6 rounded-xl shadow-lg",children:[N.jsx("h2",{className:"text-2xl font-bold text-gray-800 mb-4",children:"Lista de Órdenes"}),r.length===0?N.jsx("p",{className:"text-gray-600",children:"No hay órdenes registradas."}):N.jsx("div",{className:"overflow-x-auto",children:N.jsxs("table",{className:"min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden",children:[N.jsx("thead",{className:"bg-gray-50",children:N.jsxs("tr",{children:[N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"ID Orden"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Fecha"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Total"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Estado"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Productos"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Cliente"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Dirección de Envío"}),N.jsx("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",children:"Acciones"})]})}),N.jsx("tbody",{className:"bg-white divide-y divide-gray-200",children:r.map(p=>{var g,S;return N.jsxs("tr",{children:[N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900",children:p.id}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:p.fechaOrden&&typeof p.fechaOrden.toDate=="function"?p.fechaOrden.toDate().toLocaleDateString():"N/A"}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:typeof p.total=="number"&&!isNaN(p.total)?`$${p.total.toFixed(2)}`:"0.00"}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap",children:N.jsx("span",{className:`px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                        ${p.estado==="entregado"?"bg-green-100 text-green-800":p.estado==="cancelado"?"bg-red-100 text-red-800":"bg-yellow-100 text-yellow-800"}`,children:typeof p.estado=="string"?p.estado:"Estado Inválido"})}),N.jsx("td",{className:"px-6 py-4 text-sm text-gray-500",children:N.jsx("ul",{className:"list-disc list-inside",children:p.items&&p.items.map((P,C)=>N.jsxs("li",{children:[P.name," (x",P.quantity,")"]},C))})}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm text-gray-500",children:((g=p.shippingDetails)==null?void 0:g.fullName)||"N/A"}),N.jsx("td",{className:"px-6 py-4 text-sm text-gray-500",children:((S=p.shippingDetails)==null?void 0:S.address)||"N/A"}),N.jsx("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium",children:N.jsx("select",{value:typeof p.estado=="string"?p.estado:"",onChange:P=>f(p.id,P.target.value),className:"mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md shadow-sm",children:h.map(P=>N.jsx("option",{value:P,children:P},P))})})]},p.id)})})]})})]}),N.jsx(Ti,{...n})]})};function ON(){const{modalState:t,showAlert:e}=Hf(),[n,r]=te.useState(null),[i,s]=te.useState(!1),[o,l]=te.useState(!0),[u,h]=te.useState("dashboard"),[f,p]=te.useState(!1),g=hT.useMemo(()=>{try{console.log("App.jsx: Iniciando inicialización de Firebase..."),console.log("App.jsx: Valor de __app_id (global):",typeof __app_id<"u"?__app_id:"NO DEFINIDO"),console.log("App.jsx: Valor de __firebase_config (global):",typeof __firebase_config<"u"?__firebase_config:"NO DEFINIDO"),console.log("App.jsx: Valor de localFirebaseConfig (importado):",el);let I={};if(typeof __firebase_config<"u"&&__firebase_config&&Object.keys(JSON.parse(__firebase_config)).length>0)I=JSON.parse(__firebase_config),console.log("App.jsx: Usando configuración de Firebase de __firebase_config (global).");else if(Object.keys(el).length>0)I=el,console.log("App.jsx: Usando configuración de Firebase de localFirebaseConfig (archivo).");else throw new Error("La configuración de Firebase no está disponible. Por favor, proporciónala.");console.log("App.jsx: Configuración de Firebase final a usar:",I);const D=qS().length===0?Hd(I):su(),M=Pw(D),F=FE(D),v=y0(D);return console.log("App.jsx: Firebase inicializado con éxito."),{app:D,auth:M,db:F,storage:v,error:null}}catch(I){return console.error("App.jsx: Error al inicializar Firebase:",I),{app:null,auth:null,db:null,storage:null,error:I.message}}},[]),{app:S,auth:P,db:C,storage:b,error:T}=g;te.useEffect(()=>{if(!P||!C||T){l(!1);return}const I=rP(P,async D=>{var M,F;if(r(D),console.log("App.jsx: onAuthStateChanged - Usuario actual:",D?D.email:"Ninguno"),D){try{console.log(`App.jsx: Verificando rol para UID: ${D.uid}`);const v=Ro(C,"users",D.uid),y=await fx(v);y.exists()&&y.data().role==="admin"?(console.log("App.jsx: Usuario es administrador."),s(!0),f||(e("¡Inicio de sesión exitoso como Administrador!"),p(!0))):(console.log("App.jsx: Usuario NO es administrador o rol no definido. Documento existe:",y.exists(),"Rol:",(M=y.data())==null?void 0:M.role),s(!1),r(null),e("Acceso denegado: No tienes permisos de administrador.","error"),await Ac(P),console.log("App.jsx: Sesión de usuario no-admin cerrada."),p(!1))}catch(v){console.error("App.jsx: Error al obtener el rol del usuario:",v),s(!1),r(null),e("Error al verificar permisos. Por favor, intenta iniciar sesión de nuevo.","error"),await Ac(P),console.log("App.jsx: Sesión cerrada debido a error en verificación de rol."),p(!1)}if(typeof __initial_auth_token<"u"&&__initial_auth_token)try{(!D||D.uid!==((F=P.currentUser)==null?void 0:F.uid))&&(await JR(P,__initial_auth_token),console.log("App.jsx: Sesión iniciada con token personalizado (posiblemente para Canvas)."))}catch(v){console.error("App.jsx: Error al iniciar sesión con token personalizado:",v),e(`Error al iniciar sesión con token personalizado: ${v.message}`)}}else console.log("App.jsx: No hay usuario logueado."),s(!1),r(null),h("dashboard"),p(!1);l(!1),console.log(`App.jsx: Fin de onAuthStateChanged. currentUser: ${D?D.email:"null"}, isAdmin: ${i}`)});return()=>I()},[P,C,e,f]);const _=async()=>{if(P)try{await Ac(P),e("¡Sesión cerrada con éxito!"),h("dashboard"),p(!1)}catch(I){console.error("Error al cerrar sesión:",I),e(`Error al cerrar sesión: ${I.message}`)}};return o?N.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100",children:N.jsx("div",{className:"text-xl font-semibold text-gray-700",children:"Cargando autenticación..."})}):T?N.jsxs("div",{className:"min-h-screen flex items-center justify-center bg-red-100 text-red-800 p-4",children:[N.jsxs("p",{className:"text-lg text-center",children:["Error: No se pudo inicializar Firebase. ",T,". Por favor, verifica la configuración."]}),N.jsx(Ti,{...t})]}):!S||!C||!P||!b?N.jsxs("div",{className:"min-h-screen flex items-center justify-center bg-red-100 text-red-800 p-4",children:[N.jsx("p",{className:"text-lg text-center",children:"Error: Componentes de Firebase no disponibles."}),N.jsx(Ti,{...t})]}):!n||!i?(console.log("App.jsx: Mostrando Login. currentUser:",n?n.email:"null","isAdmin:",i),N.jsxs(Ki.Provider,{value:{db:C,auth:P,storage:b,currentUser:n,showAlert:e},children:[N.jsx(CN,{}),N.jsx(Ti,{...t})]})):(console.log("App.jsx: Mostrando Panel de Administrador. currentUser:",n.email,"isAdmin:",i),N.jsxs(Ki.Provider,{value:{db:C,auth:P,storage:b,currentUser:n,showAlert:e},children:[N.jsxs("div",{className:"flex flex-col min-h-screen bg-gray-100 font-inter",children:[N.jsx("nav",{className:"bg-blue-700 p-4 text-white shadow-lg",children:N.jsxs("div",{className:"container mx-auto flex justify-between items-center",children:[N.jsx("h1",{className:"text-2xl font-bold",children:"Panel de Administrador"}),N.jsxs("div",{className:"flex items-center space-x-4",children:[N.jsxs("span",{className:"text-sm",children:["Usuario: ",n.email||n.uid]}),N.jsx("button",{onClick:_,className:"bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md transition-colors shadow-md",children:"Cerrar Sesión"})]})]})}),N.jsxs("div",{className:"flex flex-1",children:[N.jsx("aside",{className:"w-64 bg-blue-800 text-white p-6 shadow-xl",children:N.jsxs("nav",{className:"space-y-4",children:[N.jsx("button",{onClick:()=>h("dashboard"),className:`w-full text-left px-4 py-3 rounded-md transition-colors ${u==="dashboard"?"bg-blue-600":"hover:bg-blue-700"}`,children:"Dashboard"}),N.jsx("button",{onClick:()=>h("products"),className:`w-full text-left px-4 py-3 rounded-md transition-colors ${u==="products"?"bg-blue-600":"hover:bg-blue-700"}`,children:"Productos"}),N.jsx("button",{onClick:()=>h("orders"),className:`w-full text-left px-4 py-3 rounded-md transition-colors ${u==="orders"?"bg-blue-600":"hover:bg-blue-700"}`,children:"Órdenes"})]})}),N.jsxs("main",{className:"flex-1 p-6",children:[u==="dashboard"&&N.jsx(xN,{}),u==="products"&&N.jsx(NN,{}),u==="orders"&&N.jsx(DN,{})]})]})]}),N.jsx(Ti,{...t})]}))}Vv(document.getElementById("root")).render(N.jsx(te.StrictMode,{children:N.jsx(ON,{})}));
